...
const Immigration = ({ user, onLogout }) => {
  ...
  const pricingTiers = [
    {
      title: t("immigration.pricing1.title"),
      price: t("immigration.pricing1.price"),
      priceNote: t("immigration.pricing1.priceNote"),
      features: [
        t("immigration.pricing1.feature1"),
        t("immigration.pricing1.feature2"),
        t("immigration.pricing1.feature3"),
        t("immigration.pricing1.feature4"),
        t("immigration.pricing1.feature5"),
      ],
      buttonText: t("immigration.pricing1.buttonText"),
      buttonClass:
    ...
    {
      title: t("immigration.pricing2.title"),
      price: t("immigration.pricing2.price"),
      priceNote: t("immigration.pricing2.priceNote"),
      features: [
        t("immigration.pricing2.feature1"),
        t("immigration.pricing2.feature2"),
        t("immigration.pricing2.feature3"),
        t("immigration.pricing2.feature4"),
      ],
      buttonText: t("immigration.pricing2.buttonText"),
      badge: t("immigration.pricing2.badge"),
      buttonClass:
    ...
    {
      title: t("immigration.pricing3.title"),
      price: t("immigration.pricing3.price"),
      priceNote: t("immigration.pricing3.priceNote"),
      features: [
        t("immigration.pricing3.feature1"),
        t("immigration.pricing3.feature2"),
        t("immigration.pricing3.feature3"),
        t("immigration.pricing3.feature4"),
      ],
      buttonText: t("immigration.pricing3.buttonText"),
      buttonClass:
        "w-full bg-[#002346] text-white font-semibold py-3 px-6 rounded-lg hover:bg-[#B57560] transition-colors duration-300 transform hover:scale-105",
      boxStyle: { background: "#AABF91", color: "#002346" },
      className:
  ...
  const benefits = [
    t("immigration.benefit1"),
    t("immigration.benefit2"),
    t("immigration.benefit3"),
    t("immigration.benefit4"),
    t("immigration.benefit5"),
    t("immigration.benefit6"),
  ];

  const services = [
    {
      title: t("immigration.service1.title"),
      description: t("immigration.service1.desc"),
    },
    {
      title: t("immigration.service2.title"),
      description: t("immigration.service2.desc"),
    },
    {
      title: t("immigration.service3.title"),
      description: t("immigration.service3.desc"),
    },
    {
      title: t("immigration.service4.title"),
      description: t("immigration.service4.desc"),
    },
    {
      title: t("immigration.service5.title"),
      description: t("immigration.service5.desc"),
    },
    {
      title: t("immigration.service6.title"),
      description: t("immigration.service6.desc"),
    },
  ];
    ...
    >
      ...
      >
        ...
        >
          ...
          {t("immigration.hero.noVideoSupport")}
        </video>
      ...
      >
        <div className="max-w-7xl mx-auto w-full">
          ...
          >
            ...
            >
              {t("immigration.benefits.title")}
            </h2>
            <p
              className="text-lg max-w-2xl mx-auto"
              style={{ color: darkMode ? "#F8F4E3" : "#333333" }}
            >
              {t("immigration.benefits.subtitle")}
            </p>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3
                ...
                style={{ color: darkMode ? "#F8F4E3" : "#002346" }}
              >
                {t("immigration.benefits.imageTitle")}
              </h3>
              <p
                className="text-lg max-w-md self-center lg:self-start"
                style={{ color: darkMode ? "#F8F4E3" : "#333333" }}
              >
                {t("immigration.benefits.imageSubtitle")}
              </p>
            </div>
            <div
              className="space-y-8"
            ...
            <div className="flex flex-col items-center mx-3 w-[120px]">
              ...
              <div className="flex flex-col items-center mt-2">
                <h3
                  ...
                  style={{ color: darkMode ? "#F8F4E3" : "#002346" }}
                >
                  {t("immigration.howWeWork.step1.title")}
                </h3>
                <p
                  className="text-center text-xs mt-1"
                  style={{ color: darkMode ? "#F8F4E3" : "#333333" }}
                >
                  {t("immigration.howWeWork.step1.desc")}
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center mx-3 w-[120px]">
              ...
              <div className="flex flex-col items-center mt-2">
                <h3
                  ...
                  style={{ color: darkMode ? "#F8F4E3" : "#002346" }}
                >
                  {t("immigration.howWeWork.step2.title")}
                </h3>
                <p
                  className="text-center text-xs mt-1"
                  style={{ color: darkMode ? "#F8F4E3" : "#333333" }}
                >
                  {t("immigration.howWeWork.step2.desc")}
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center mx-3 w-[120px]">
              ...
              <div className="flex flex-col items-center mt-2">
                <h3
                  ...
                  style={{ color: darkMode ? "#F8F4E3" : "#002346" }}
                >
                  {t("immigration.howWeWork.step3.title")}
                </h3>
                <p
                  className="text-center text-xs mt-1"
                  style={{ color: darkMode ? "#F8F4E3" : "#333333" }}
                >
                  {t("immigration.howWeWork.step3.desc")}
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center mx-3 w-[120px]">
              ...
              <div className="flex flex-col items-center mt-2">
                <h3
                  ...
                  style={{ color: darkMode ? "#F8F4E3" : "#002346" }}
                >
                  {t("immigration.howWeWork.step4.title")}
                </h3>
                <p
                  className="text-center text-xs mt-1"
                  style={{ color: darkMode ? "#F8F4E3" : "#333333" }}
                >
                  {t("immigration.howWeWork.step4.desc")}
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center mx-3 w-[120px]">
              ...
              <div className="flex flex-col items-center mt-2">
                <h3
                  ...
                  style={{ color: darkMode ? "#F8F4E3" : "#002346" }}
                >
                  {t("immigration.howWeWork.step5.title")}
                </h3>
                <p
                  className="text-center text-xs mt-1"
                  style={{ color: darkMode ? "#F8F4E3" : "#333333" }}
                >
                  {t("immigration.howWeWork.step5.desc")}
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center mx-3 w-[120px]">
              ...
              <div className="flex flex-col items-center mt-2">
                <h3
                  ...
                  style={{ color: darkMode ? "#F8F4E3" : "#002346" }}
                >
                  {t("immigration.howWeWork.step6.title")}
                </h3>
                <p
                  className="text-center text-xs mt-1"
                  style={{ color: darkMode ? "#F8F4E3" : "#333333" }}
                >
                  {t("immigration.howWeWork.step6.desc")}
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center mx-3 w-[120px]">
              ...
              <div className="flex flex-col items-center mt-2">
                <h3
                  ...
                  style={{ color: darkMode ? "#F8F4E3" : "#002346" }}
                >
                  {t("immigration.howWeWork.step7.title")}
                </h3>
                <p
                  className="text-center text-xs mt-1"
                  style={{ color: darkMode ? "#F8F4E3" : "#333333" }}
                >
                  {t("immigration.howWeWork.step7.desc")}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col space-y-8" data-aos="fade-right">
              <div>
                <h2
                  ...
                  style={{ color: "#F8F4E3" }}
                >
                  {t("immigration.features.title")}
                </h2>
                <p className="text-xl mb-8" style={{ color: "#F8F4E3" }}>
                  {t("immigration.features.subtitle")}
                </p>
              </div>
              <div className="space-y-6">
                <p
                  ...
                  style={{ color: "#F8F4E3" }}
                >
                  {t("immigration.features.desc1")}
                </p>
                <p
                  className="text-base leading-relaxed"
                  style={{ color: "#F8F4E3" }}
                >
                  {t("immigration.features.desc2")}
                </p>
                <p
                  className="text-base leading-relaxed"
                  style={{ color: "#F8F4E3" }}
                >
                  {t("immigration.features.desc3")}
                </p>
                <p
                  className="text-base leading-relaxed"
                  style={{ color: "#F8F4E3" }}
                >
                  {t("immigration.features.desc4")}
                </p>
              </div>
            </div>
            <div
              ...
              {features.map((feature, index) => (
                ...
                >
                  ...
                  <p className="text-base">
                    {t("immigration.features.benefit", { feature })}
                  </p>
                </div>
              ))}
            </div>
      ...
      >
        <div className="max-w-6xl mx-auto text-center w-full">
          ...
          <p
            ...
            data-aos-delay="100"
          >
            {t("immigration.pricing.subtitle")}
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            {pricingTiers.map((tier, i) => (
              ...
              >
                ...
                {tier.buttonText === t("immigration.pricing1.buttonText") && (
                  <button
                ...
                {tier.buttonText === t("immigration.pricing2.buttonText") && (
                  <button
                    className="w-full font-semibold py-3 px-6 rounded-lg transition-colors duration-300"
                    style={{
                      background: COLOR_1,
                ...
                {tier.buttonText === t("immigration.pricing3.buttonText") && (
                  <button
                    className="w-full font-semibold py-3 px-6 rounded-lg transition-colors duration-300"
                    style={{
                      background: COLOR_1,
