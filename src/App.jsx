        ...
        <Router>
          ...
          <Routes>
            ...
            <Route
              ...
              element={<Criminal user={user} onLogout={handleLogout} />}
            />
            <Route
              path="/blog"
            ...
            <Route
              ...
              element={<Corporate user={user} onLogout={handleLogout} />}
            />
            <Route
              path="/services/civil"
              element={<Civil user={user} onLogout={handleLogout} />}
            />
            <Route
              path="/services/family"
              element={<Family user={user} onLogout={handleLogout} />}
            />
            <Route
              path="/services/real-estate"
              element={<RealEstate user={user} onLogout={handleLogout} />}
            />
            <Route
              path="/services"
            ...
            <Route
              ...
              element={<Immigration user={user} onLogout={handleLogout} />}
            />
            <Route
              path="/about"
            ...
            />
            <Route
              path="/blog/bail-application-process"
              element={
                <BailApplicationProcess user={user} onLogout={handleLogout} />
              }
            />
            <Route
              path="/blog/white-collar-crime-defenses"
              element={
                <WhiteCollarCrimeDefenses user={user} onLogout={handleLogout} />
              }
            />
            <Route
              path="/blog/understanding-your-rights"
              element={
                <UnderstandingYourRights user={user} onLogout={handleLogout} />
              }
            />
          </Routes>
        </Router>
