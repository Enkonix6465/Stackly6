...
const Civil = ({ user, onLogout }) => {
  ...
  const services = [
    {
      title: t("civil.service1.title"),
      description: t("civil.service1.desc"),
    },
    {
      title: t("civil.service2.title"),
      description: t("civil.service2.desc"),
    },
    {
      title: t("civil.service3.title"),
      description: t("civil.service3.desc"),
    },
    {
      title: t("civil.service4.title"),
      description: t("civil.service4.desc"),
    },
    {
      title: t("civil.service5.title"),
      description: t("civil.service5.desc"),
    },
    {
      title: t("civil.service6.title"),
      description: t("civil.service6.desc"),
    },
  ];

  const pricingTiers = [
    {
      title: t("civil.pricing1.title"),
      price: t("civil.pricing1.price"),
      priceNote: t("civil.pricing1.priceNote"),
      features: [
        t("civil.pricing1.feature1"),
        t("civil.pricing1.feature2"),
        t("civil.pricing1.feature3"),
      ],
      buttonText: t("civil.pricing1.buttonText"),
    ...
    {
      title: t("civil.pricing2.title"),
      price: t("civil.pricing2.price"),
      priceNote: t("civil.pricing2.priceNote"),
      features: [
        t("civil.pricing2.feature1"),
        t("civil.pricing2.feature2"),
        t("civil.pricing2.feature3"),
        t("civil.pricing2.feature4"),
      ],
      buttonText: t("civil.pricing2.buttonText"),
      ...
      badge: t("civil.pricing2.badge"),
      boxStyle: { background: COLOR_1, color: COLOR_2 },
      className: `rounded-2xl p-6 border-2 border-${COLOR_1} scale-105`,
    },
    {
      title: t("civil.pricing3.title"),
      price: t("civil.pricing3.price"),
      priceNote: t("civil.pricing3.priceNote"),
      features: [
        t("civil.pricing3.feature1"),
        t("civil.pricing3.feature2"),
        t("civil.pricing3.feature3"),
        t("civil.pricing3.feature4"),
      ],
      buttonText: t("civil.pricing3.buttonText"),
      buttonClass: `w-full bg-${COLOR_1} text-white font-semibold py-3 px-6 rounded-lg hover:bg-[#B57560] transition-colors duration-300 transform hover:scale-105`,
      boxStyle: { background: COLOR_2, color: COLOR_3 },
      className: `rounded-2xl p-6 border-2 border-${COLOR_1} hover:border-${COLOR_3} transition-all duration-300`,
    },
  ...
  return (
    ...
    >
      <div
        className={`fixed top-0 left-0 w-full z-[100] ${darkMode ? `bg-[${COLOR_3}]` : `bg-[${COLOR_2}]`} shadow-lg`}
      >
        <Header
          darkMode={darkMode}
      ...
      >
        <div className="max-w-7xl mx-auto w-full">
          ...
          >
            ...
            >
              {t("civil.benefits.title")}
            </h2>
            <p
              className="text-lg max-w-2xl mx-auto"
              style={{ color: darkMode ? "#F8F4E3" : "#333333" }}
            >
              {t("civil.benefits.subtitle")}
            </p>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 justify-items-center">
            ...
            >
              ...
              <h3
                ...
                style={{ color: darkMode ? "#F8F4E3" : "#002346" }}
              >
                {t("civil.benefits.imageTitle")}
              </h3>
              <p
                className="text-lg max-w-md self-center lg:self-start"
                style={{ color: darkMode ? "#F8F4E3" : "#333333" }}
              >
                {t("civil.benefits.imageSubtitle")}
              </p>
            </div>
            ...
            <div className="flex flex-col items-center mx-3 w-[120px]">
              ...
              <div className="flex flex-col items-center mt-2">
                <h3
                  ...
                  style={{ color: darkMode ? "#F8F4E3" : "#002346" }}
                >
                  {t("civil.howWeWork.step1.title")}
                </h3>
                <p
                  className="text-center text-xs mt-1"
                  style={{ color: darkMode ? "#F8F4E3" : "#333333" }}
                >
                  {t("civil.howWeWork.step1.desc")}
                </p>
              </div>
            </div>
            {/* STEP 2 */}
            <div className="flex flex-col items-center mx-3 w-[120px]">
              ...
              <div className="flex flex-col items-center mt-2">
                <h3
                  ...
                  style={{ color: darkMode ? "#F8F4E3" : "#002346" }}
                >
                  {t("civil.howWeWork.step2.title")}
                </h3>
                <p
                  className="text-[#333333] text-center text-xs mt-1"
                  style={{ color: darkMode ? "#F8F4E3" : "#333333" }}
                >
                  {t("civil.howWeWork.step2.desc")}
                </p>
              </div>
            </div>
            {/* STEP 3 */}
            <div className="flex flex-col items-center mx-3 w-[120px]">
              ...
              <div className="flex flex-col items-center mt-2">
                <h3
                  ...
                  style={{ color: darkMode ? "#F8F4E3" : "#002346" }}
                >
                  {t("civil.howWeWork.step3.title")}
                </h3>
                <p
                  className="text-[#333333] text-center text-xs mt-1"
                  style={{ color: darkMode ? "#F8F4E3" : "#333333" }}
                >
                  {t("civil.howWeWork.step3.desc")}
                </p>
              </div>
            </div>
            {/* STEP 4 */}
            <div className="flex flex-col items-center mx-3 w-[120px]">
              ...
              <div className="flex flex-col items-center mt-2">
                <h3
                  ...
                  style={{ color: darkMode ? "#F8F4E3" : "#002346" }}
                >
                  {t("civil.howWeWork.step4.title")}
                </h3>
                <p
                  className="text-[#333333] text-center text-xs mt-1"
                  style={{ color: darkMode ? "#F8F4E3" : "#333333" }}
                >
                  {t("civil.howWeWork.step4.desc")}
                </p>
              </div>
            </div>
            {/* STEP 5 */}
            <div className="flex flex-col items-center mx-3 w-[120px]">
              ...
              <div className="flex flex-col items-center mt-2">
                <h3
                  ...
                  style={{ color: darkMode ? "#F8F4E3" : "#002346" }}
                >
                  {t("civil.howWeWork.step5.title")}
                </h3>
                <p
                  className="text-[#333333] text-center text-xs mt-1"
                  style={{ color: darkMode ? "#F8F4E3" : "#333333" }}
                >
                  {t("civil.howWeWork.step5.desc")}
                </p>
              </div>
            </div>
            {/* STEP 6 */}
            <div className="flex flex-col items-center mx-3 w-[120px]">
              ...
              <div className="flex flex-col items-center mt-2">
                <h3
                  ...
                  style={{ color: darkMode ? "#F8F4E3" : "#002346" }}
                >
                  {t("civil.howWeWork.step6.title")}
                </h3>
                <p
                  className="text-[#333333] text-center text-xs mt-1"
                  style={{ color: darkMode ? "#F8F4E3" : "#333333" }}
                >
                  {t("civil.howWeWork.step6.desc")}
                </p>
              </div>
            </div>
            {/* STEP 7 */}
            <div className="flex flex-col items-center mx-3 w-[120px]">
              ...
              <div className="flex flex-col items-center mt-2">
                <h3
                  ...
                  style={{ color: darkMode ? "#F8F4E3" : "#002346" }}
                >
                  {t("civil.howWeWork.step7.title")}
                </h3>
                <p
                  className="text-[#333333] text-center text-xs mt-1"
                  style={{ color: darkMode ? "#F8F4E3" : "#333333" }}
                >
                  {t("civil.howWeWork.step7.desc")}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col space-y-8" data-aos="fade-right">
              <div>
                <h2
                  ...
                  style={{ color: COLOR_2 }}
                >
                  {t("civil.features.title")}
                </h2>
                <p className="text-xl mb-8" style={{ color: COLOR_2 }}>
                  {t("civil.features.subtitle")}
                </p>
              </div>
              <div className="space-y-6">
                <p
                  ...
                  style={{ color: COLOR_2 }}
                >
                  {t("civil.features.desc1")}
                </p>
                <p
                  className="text-base leading-relaxed"
                  style={{ color: COLOR_2 }}
                >
                  {t("civil.features.desc2")}
                </p>
                <p
                  className="text-base leading-relaxed"
                  style={{ color: COLOR_2 }}
                >
                  {t("civil.features.desc3")}
                </p>
                <p
                  className="text-base leading-relaxed"
                  style={{ color: COLOR_2 }}
                >
                  {t("civil.features.desc4")}
                </p>
              </div>
            </div>
            {/* Features as cards */}
              ...
              {features.map((feature, index) => (
                ...
                >
                  ...
                  <p className="text-base">
                    {t("civil.features.benefit", { feature })}
                  </p>
                </div>
              ))}
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            {pricingTiers.map((tier, i) => (
              ...
              >
                ...
                {tier.buttonText === t("civil.pricing1.buttonText") && (
                  <button
                ...
                {tier.buttonText === t("civil.pricing2.buttonText") && (
                  <button
                    className="w-full font-semibold py-3 px-6 rounded-lg transition-colors duration-300"
                    style={{
                      background: COLOR_1,
                ...
                {tier.buttonText === t("civil.pricing3.buttonText") && (
                  <button
                    className="w-full font-semibold py-3 px-6 rounded-lg transition-colors duration-300"
                    style={{
                      background: COLOR_1,
